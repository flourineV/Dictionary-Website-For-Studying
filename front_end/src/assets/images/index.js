const images = {
  ...
  translate: require("../images/translate.jpg"),
  flashcards: require("../images/flashcards.png"),
  exercises: require("../images/exercises.jpg"),
  studymaterials: require("../images/studymaterials.jpg"),
  writing: require("../images/writing.png"),
  lofitrang: require("../images/lofitrang.jpg"),
  lofiden: require("../images/lofiden.jpg"),
